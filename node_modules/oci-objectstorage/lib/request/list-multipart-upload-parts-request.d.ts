...
/**
 * @example Click {@link https://docs.cloud.oracle.com/en-us/iaas/tools/typescript-sdk-examples/2.86.3/objectstorage/ListMultipartUploadParts.ts.html |here} to see how to use ListMultipartUploadPartsRequest.
 */
